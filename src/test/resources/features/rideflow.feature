Feature: Ride Flow End-to-End
  ...
  Scenario: Driver and User complete a ride
    ...
    And Driver sets location with lat 28.633607330894947 and lon 77.19998624068485
    ...
    When User sends Verify request with otp "7891" and deviceToken "5497873d-10ca-42f3-8a32-22de4c916026"
